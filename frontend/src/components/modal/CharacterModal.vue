...
<template>
  <BaseModal title="Customizer" @close-modal="$emit('close-modal')">
    <div class="flex flex-col items-center h-full">
      <!-- 선택된 캐릭터 미리보기 -->
      <div
        class="relative w-[40vw] aspect-square flex items-center justify-center mb-4 border-2 border-gray-500 bg-gray-100 rounded-md"
      >
        <img
          v-if="selected.face"
          :src="selected.face[0]"
