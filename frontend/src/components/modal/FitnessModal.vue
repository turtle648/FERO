...
<template>
  <BaseModal title="운동 선택" @close-modal="$emit('close-modal')">
    ...
    <div class="flex flex-col w-full space-y-4">
      ...
      <!-- 준비중인 운동들 -->
      <button 
        class="w-full px-4 py-2 bg-gray-300 text-gray-600 rounded-lg 
               cursor-not-allowed"
        disabled
      >
        런지
    ...
    >
      <div class="bg-white p-5 rounded-lg shadow-md w-[80%] max-w-md">
        ...
        <div class="flex flex-col space-y-4">
          ...
          <button 
            class="mode-button"
            :class="{ 'opacity-50': !selectedNumber }"
            ...
            <div class="flex space-x-4">
              <button 
                ...
                :class="[
                  ...
                  selectedNumber === num 
                    ? 'bg-white text-indigo-500 font-bold ring-2 ring-indigo-500'
